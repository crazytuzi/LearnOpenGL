...
int main()
{
    ...
    // ------------------------------
    const Shader pbrShader("Shaders/2.2.1.pbr.vs", "Shaders/2.2.1.pbr.fs");

    const Shader equirectangularToCubemapShader("Shaders/2.2.1.cubemap.vs",
                                                "Shaders/2.2.1.equirectangular_to_cubemap.fs");

    const Shader irradianceShader("Shaders/2.2.1.cubemap.vs", "Shaders/2.2.1.irradiance_convolution.fs");

    const Shader prefilterShader("Shaders/2.2.1.cubemap.vs", "Shaders/2.2.1.prefilter.fs");

    const Shader brdfShader("Shaders/2.2.1.brdf.vs", "Shaders/2.2.1.brdf.fs");

    const Shader backgroundShader("Shaders/2.2.1.background.vs", "Shaders/2.2.1.background.fs");
    ...
    for (auto mip = 0; mip < maxMipLevels; ++mip)
    {
        ...
        auto mipWidth = 128 * std::pow(0.5, mip);

        auto mipHeight = 128 * std::pow(0.5, mip);
