...
int main()
{
	...
	// ------------------------------
	const Shader shader("Shaders/3.1.blending.vs", "Shaders/3.1.blending.fs");
	 ...
	 * in a counter-clockwise order. This takes some practice, but try visualizing this yourself and see that this is correct.
	 */
	float cubeVertices[] = {
		/* Back face */
