...
int main()
{
	...
	// ------------------------------
	const Shader shader("Shaders/5.1.framebuffers.vs", "Shaders/5.1.framebuffers.fs");

	const Shader screenShader("Shaders/5.1.framebuffers_screen.vs", "Shaders/5.1.framebuffers_screen.fs");
	...
	/* load textures */
	// ------------------------------
	const auto cubeTexture = loadTexture("Textures/container.jpg");
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, scr_with, scr_height, 0, GL_RGB, GL_UNSIGNED_BYTE, nullptr);
	...
	glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH24_STENCIL8, scr_with, scr_height);
